...
Welcome to [DevHub](/join), a community built by developers, for developers. Whether you just graduated a bootcamp, have been writing code for 15 years, or are somewhere in the middle, you're in the right place. Here's how to get settled in.

## Step 1: Join the Discord

Click the "Join Discord" button on the top navbar. You'll land in `#welcome`. read `#info`, it has everything you need to know in one place.
