...
> [!DANGER]
> Any bot requesting Administrator or other elevated permissions is automatically rejected, no exceptions. If the bot 'needs' admin to function, the bot is not coming in.
